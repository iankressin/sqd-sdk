...
import {
    type GetKeyTaggedUnionCast,
    type GetKeyTaggedUnionSrc,
    KeyTaggedUnionValidator,
} from './composite/key-tagged-union'
import {NullableValidator} from './composite/nullable'
import {type GetPropsCast, type GetPropsSrc, ObjectValidator} from './composite/object'
import {type GetOneOfCast, type GetOneOfSrc, OneOfValidator} from './composite/one-of'
...
import {type GetTaggedUnionCast, type GetTaggedUnionSrc, TaggedUnion} from './composite/tagged-union'
...
export function record<K extends Validator<string>, V extends Validator<any>>(
    key: K,
    value: V,
): Validator<Record<GetCastType<K>, GetCastType<V>>, Record<GetSrcType<K>, GetSrcType<V>>> {
...
export function tuple<T1 extends Validator<any>, T2 extends Validator<any>>(
    t1: T1,
    t2: T2,
): Validator<[GetCastType<T1>, GetCastType<T2>], [GetSrcType<T1>, GetSrcType<T2>]>
export function tuple<T1 extends Validator<any>, T2 extends Validator<any>, T3 extends Validator<any>>(
    t1: T1,
    t2: T2,
    t3: T3,
): Validator<[GetCastType<T1>, GetCastType<T2>, GetCastType<T3>], [GetSrcType<T1>, GetSrcType<T2>, GetSrcType<T3>]>
...
export function nullable<V extends Validator<any>>(item: V): Validator<GetCastType<V> | null, GetSrcType<V> | null> {
